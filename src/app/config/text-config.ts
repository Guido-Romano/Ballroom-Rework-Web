export const TextConfig = {
  articles: [
    ...
    },
    {
      ...
      articleIntro: '¡Sí! La primera clase siempre es gratis, ¡puedes venir a ver o probar sin compromiso!',
      articleMoreText: '',
      imageUrl: '',
      articleLink: ''
    },
    ...
    },
    {
      ...
      articleIntro: 'Debido a los niveles de inflación en la actualidad, el precio puede consultarse directamente comunicándose con nosotros por WhatsApp.',
      articleMoreText: '',
      imageUrl: '',
      articleLink: ''
    },
    ...
    {
      id: 9,
      articleHeading: '¿Debo ir acompañado a las clases?',
      articleIntro: 'No es necesario, pero para una mejor experiencia te recomendamos hacerlo.',
      articleMoreText: '',
      imageUrl: '',
      articleLink: ''
    },
    ...
    // NOSOTROS
    {
      ...
      articleIntro: 'Trabajo en la Administración de nuestras redes e ideas creativas tanto en diseño como para el modelo de nuestro negocio.',
      articleMoreText: '',
      imageUrl: '',
      articleLink: ''
    },
    {
      id: 102,
      articleHeading: 'Juan Manuel Almirón, CEO',
      articleIntro: 'Creador de BASC Argentina. Comparto mi gran pasión por el baile con aquellas personas que tengan ganas de aprender.',
      articleMoreText: '',
      imageUrl: '',
      articleLink: ''
    },
    {
      id: 103,
      articleHeading: 'Guido Romano, Desarrollador',
    ...
    {
      id: 107,
      articleHeading: 'Detrás de un buen bailarín SIEMPRE hay un gran maestro de danza.',
      articleIntro: 'Porque inspiran con su pasión por bailar. Son fuente de motivación y el vínculo que realiza un bailarín con su entrenador puede ser tan fuerte como el de un padre con su hijo...',
      articleMoreText: 'Porque hay entrenadores que se convierten en padres y padres que se vuelven entrenadores.',
      imageUrl: '',
      articleLink: ''
    },
     ...
     
    {
      ...
      articleMoreText: 'Hay gente que me canta la musicalidad con el cuerpo, sin escuchar la música ya sé que ritmo están bailando.\n\nEn varios casos, el bailarín o la bailarina, siempre estuvieron ahí, solo tengo que sacar las cuerdas que le sujetan.',
      imageUrl: '',
      articleLink: ''
    },
    ...
    {
      id: 205,
      articleHeading: 'Técnica perfecta',
      ...
      articleMoreText: 'Pero no es un Dios al que reverenciar ciegamente y si no es así, está mal, no baila.... no seas esclavo de la teoría. Experimenta, prueba por ti mismo.',
      imageUrl: '',
      articleLink: ''
    },
    ...
    {
      id: 207,
      articleHeading: '¿Por qué aconsejo a los hombres aprender la parte coreográfica de las mujeres?',
      articleIntro: 'Tú serás quien conduce, por lo tanto deberás saber que pasos debe hacer ella.',
      articleMoreText: 'Aprendar su coreografía y sus figuras, te hará entender que debe sentir ella y como, para que ella pueda desplegarse mejor en la coreografía.',
      imageUrl: '',
      articleLink: ''
    },
