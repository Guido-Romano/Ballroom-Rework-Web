export const TextConfig = {
  ...
  personal: [
    {
      id: 1,
      titulo: 'Cecilia Bulgarelli, Com. Manager',
    ...
    pregunta: [
    {
      ...
      info: '"Ballroom" es la denominación que se usa para designar un conjunto de 10 ritmos. Pertenecen a los llamados ritmos "Standard".',
      info2: 'Estos son: Vals Inglés, Vals Vienés, Tango, Foxtrot, Quickstep. Corresponden a los ritmos "Latin" Samba, Cha Cha Cha, Rumba, Paso Doble, Jive.',
    },

    {
      id: 2,
      titulo: '¿Ofrecen clases gratis?',
      info: '¡Sí! La primera clase siempre es gratis, ¡puedes venir a ver o probar sin compromiso!',
      info2: '',
    },
...

    {
      ...
      info: 'Sábados: 09:00 hs a 10:00 hs. / 17:30 hs a 18:30 hs. / 19:00 Hs a 20:00 hs.',
      info2: 'Domingos: 19:00 hs a 20:00 hs.',
    },

    {
      id: 5,
      titulo: '¿Dónde se realizan las clases?',
      info: 'Calle Lambaré 990, Avenida Corrientes 4534, Capital Federal.',
      info2: '',
    },

    {
      ...
      info: 'Debido a los niveles de inflación en la actualidad, el precio puede consultarse directamente comunicándose con nosotros por WhatsApp.',
      info2: '',
    },

    {
      id: 7,
      titulo: '¿Cuándo son las clases para principiantes?',
      info: 'Sábados: 17:30 hs a 18:30 hs.',
      info2: 'Domingos: 19:00 hs a 20:00 hs.',
    },

    {
      ...
      info2: 'A medida que continúes, es recomendable usar ropa y calzado específicos de ballroom.',
    },
...

{
  ...
  imagen: '',
 link: 'https://chat.whatsapp.com/IK5BVsSuMQ4LHX6Nc6cDAj'
},
